...
public class CoordinateConversions
{
    ...
    {
        double degrees[] = com.example.custom_gps.CoordinateConversions.xyzToLatLonRadians(xyz);

        degrees[0] = degrees[0] * com.example.custom_gps.CoordinateConversions.RADIANS_TO_DEGREES;
        degrees[1] = degrees[1] * com.example.custom_gps.CoordinateConversions.RADIANS_TO_DEGREES;
    ...
    {
        double degrees[] = com.example.custom_gps.CoordinateConversions.getXYZfromLatLonRadians(latitude * com.example.custom_gps.CoordinateConversions.DEGREES_TO_RADIANS,
                longitude * com.example.custom_gps.CoordinateConversions.DEGREES_TO_RADIANS,
                height);
